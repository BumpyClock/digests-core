...
- Port Go cleaners (`clean.go`, `clean_h_ones.go`, `rewrite_top_level.go`, etc.) including negative/positive regex filters, link density penalties, sibling merge steps.
- Implement all Go FunctionTransform cases (currently heuristics): data-original/data-lazy/data-zoom/srcset handling, gallery wrappers, etc.
